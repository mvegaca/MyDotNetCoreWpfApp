...
namespace MyDotNetCoreWpfApp.Notifications
{
    ...
    public class MyNotificationActivator : NotificationActivator
    {
        ...
        public MyNotificationActivator(IServiceProvider serviceProvider, INotificationsService notificationsService)
        {
            ...
            Application.Current.Dispatcher.Invoke(delegate
            {
                ...
                switch (args["action"])
                {
                    ...
                    case "viewImage":
                        ...
                        (App.Current.Windows[0] as ShellWindow).ShowImage(imageUrl);
                    ...
                    case "viewConversation":
                        ...
                        (App.Current.Windows[0] as ShellWindow).ShowConversation();
